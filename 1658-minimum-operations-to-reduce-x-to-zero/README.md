...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,1,4,2,3], x = 5
...
<pre style="position: relative;"><strong>Input:</strong> nums = [5,6,7,8,9], x = 4
<strong>Output:</strong> -1
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper" bis_skin_checked="1"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums = [3,2,20,1,1,3], x = 10
